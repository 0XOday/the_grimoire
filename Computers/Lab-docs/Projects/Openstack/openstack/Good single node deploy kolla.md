...
kolla_internal_vip_address: "192.168.129.3"  
...
#neutron_external_interface: "enp1s0f0"  
...
#enable_opensearch: "{{ enable_central_logging | bool or enable_osprofiler | bool or (enable_cloudkitty | bool and cloudkitty_storage  
...
#prometheus_cadvisor_cmdline_extras: "--docker_only --store_container_labels=false --disable_metrics=percpu,referenced_memory,cpu_top  
ology,resctrl,udp,advtcp,sched,hugetlb,memory_numa,tcp,process"  
